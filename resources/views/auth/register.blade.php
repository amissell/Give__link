    ...
    <form action="{{ route('register')}}" method="POST">
      @csrf
        <div class="mb-4">
            ...
            <input type="text" id="username" name="name" class="w-full px-3 py-2 border rounded-md" required>
        </div>
        <div class="mb-4">
        ...
        {{-- <div class="mb-4">
            ...
            <input type="password" id="confirm_password" name="password_confirmation" class="w-full px-3 py-2 border rounded-md" required>
        </div> --}}
